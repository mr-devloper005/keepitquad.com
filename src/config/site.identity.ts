export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'keepitquad',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Keepitquad',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'keepitquad.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://keepitquad.com',
